...
export const Checkout = () => {
  ...
  const isCasablanca = shippingInfo.city.toLowerCase().includes('casa');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (paymentMethod === 'paypal') {
        alert('Redirection vers PayPal... (À configurer)');
      } else {
            ...
            <div className="lg:col-span-2">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-white rounded-lg shadow p-6">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-600">
                            {isCasablanca ? 'Paiement sécurisé par carte bancaire' : 'Mode de paiement obligatoire pour les autres villes'}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  {!isCasablanca && paymentMethod === 'cash' && (
                    <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                      <p className="text-sm text-yellow-800">
                        Le paiement à la livraison n'est disponible qu'à Casablanca. Pour les autres villes, veuillez utiliser PayPal.
                      </p>
                    </div>
                  )}
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading || (!isCasablanca && paymentMethod === 'cash')}
              ...
              <div className="bg-white rounded-lg shadow p-6 sticky top-6">
                ...
                <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  <p className="text-sm text-blue-800">
                    ...
                    {isCasablanca ? 'Casablanca: 24h' : 'Autres villes: 24h-48h'}
                  </p>
                </div>
              </div>
            </div>
